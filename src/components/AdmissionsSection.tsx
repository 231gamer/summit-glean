...
export function AdmissionsSection() {
  return (
    <section className="pt-16 lg:pt-20 pb-20 lg:pb-28 bg-gradient-to-b from-background to-muted/10 overflow-hidden">
      <div className="container px-4 sm:px-6">
        {/* Header - Enhanced */}
        <ScrollReveal direction="up" className="max-w-3xl mx-auto text-center mb-16">
        ...
        <div className="relative mb-20">
          ...
          <StaggerContainer className="grid md:grid-cols-3 gap-8">
            {admissionSteps.map((step, index) => (
              <StaggerItem key={step.title} delay={index * 0.15}>
                  ...
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                    <FloatingElement intensity={3} duration={3} delay={index * 0.2}>
                      <PulseGlow
                        ...
                        intensity={15}
                        duration={2}
                        className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center text-lg font-bold shadow-lg"
                      >
                        {index + 1}
                      </PulseGlow>
                    </FloatingElement>
